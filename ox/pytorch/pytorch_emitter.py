...
""")
    ...
    def emit_ConvTranspose(self, IR_node):
        self.used_layers.add('ConvTranspose')
        ...
        self.add_init(2, "self.{} = self.__conv_transpose({}, name='{}', in_channels={}, out_channels={}, kernel_size={}, stride={}, groups={}, bias={})".format(
            IR_node.variable_name,
            dim,
            IR_node.name,
            in_channels,
    ...
    def emit_Transpose(self, IR_node):
        if self.parent_variable_name(IR_node, [1]):
