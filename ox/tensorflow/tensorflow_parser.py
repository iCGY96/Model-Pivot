...
from ox.tensorflow.tensorflow_graph import TensorflowGraph
...
class TensorflowParser(Parser):
    ...
    def _load_meta(model_network_path):
        ...
        from ox.common.IR.IR_graph import load_protobuf_from_file
    ...
    def rename_Pack(self, source_node):
        ...
        for i in range(N):
            ...
            if this_node.type == 'Const':
                ...
                # source_node.layer.input.remove(this_node.name)
            else:
                in_edge_count += 1
        
        IR_node = self._convert_identity_operation(source_node, new_op='Pack', in_edge_count=in_edge_count)
        kwargs = {
    ...
    def rename_StridedSlice(self, source_node):
        ...
        IR_node = self._convert_identity_operation(source_node, in_edge_count=1, new_op='StridedSlice')
        kwargs = {
