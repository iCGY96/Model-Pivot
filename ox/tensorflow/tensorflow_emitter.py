...
from ox.common.IR.IR_graph import IRGraph, IRGraphNode
import ox.common.IR.graph_pb2 as graph_pb2
from ox.common.IR.graph_pb2 import NodeDef, GraphDef, DataType
from ox.common.DataStructure.emitter import Emitter
from ox.common.utils import *
from ox.rewriter.folder import Folder
...
""".format(self.trainable)
    ...
    def emit_StridedSlice(self, IR_node):
        extra_str = ""
    ...
    # def emit_Less(self, IR_node):
    #     code = "{:<15} = tf.less({}, {}, name='{}')".format(
    #         IR_node.variable_name,
    #         self.parent_variable_name(IR_node, [0]),
    #         self.parent_variable_name(IR_node, [1]),
    #         IR_node.name)
    ...
    # def emit_All(self, IR_node):
    #     code = "{:<15} = tf.reduce_all({}, keep_dims={}, name='{}')".format(
    #         IR_node.variable_name,
    #         self.parent_variable_name(IR_node),
    #         # IR_node.get_attr('axis'),
    #         IR_node.get_attr('keep_dims'),
    #         IR_node.name)
    #     return code

    # def emit_Assert(self, IR_node):
    #     code = "{:<15} = tf.Assert({}, {}, name='{}')".format(
    #         IR_node.variable_name,
    #         self.parent_variable_name(IR_node, [0]),
    #         self.parent_variable_name(IR_node, [1]),
    #         IR_node.name)
